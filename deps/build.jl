...
if !isnothing(matlab_root)
    ...
    libmx_size = filesize(Libdl.dlpath("C:\\Program Files\\MATLAB\\R2021b\\bin\\win64\\libmx.dll"))
    open(depsfile, "w") do io
        println(io,
            ...
            function check_deps()
                if libmx_size != filesize(Libdl.dlpath("C:\\Program Files\\MATLAB\\R2021b\\bin\\win64\\libmx.dll"))
