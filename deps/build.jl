...
if !isnothing(matlab_root)
    ...
    open(depsfile, "w") do io
        println(io,
            ...
            function check_deps()
                if libmx_size != filesize(Libdl.dlpath("C:\\\\Program Files\\\\MATLAB\\\\R2020b\\\\bin\\\\win64\\\\libmx.dll")) #! JR DOUBLED UP \\ in "build.jl"
...
# cd("C:\\Users\\roth0674\\.julia\\packages\\MATLAB\\5RUjq\\deps\\")
